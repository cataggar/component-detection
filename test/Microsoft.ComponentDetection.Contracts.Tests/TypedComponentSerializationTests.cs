...
public class TypedComponentSerializationTests
{
    ...
    public void TypedComponent_Serialization_Other()
    {
        ...
        var result = JsonSerializer.Serialize(tc, JsonOptions);
        var deserializedTC = JsonSerializer.Deserialize<TypedComponent>(result, JsonOptions);
    ...
    public void TypedComponent_Serialization_Npm()
    {
        ...
        var result = JsonSerializer.Serialize(npmCompObj, JsonOptions);
        var deserializedTC = JsonSerializer.Deserialize<TypedComponent>(result, JsonOptions);
