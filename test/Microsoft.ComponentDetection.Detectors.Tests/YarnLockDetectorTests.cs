...
public class YarnLockDetectorTests : BaseDetectorTest<YarnLockComponentDetector>
{
    ...
    public async Task WellFormedYarnLockV1WithWorkspace_FindsComponentAsync()
    {
        ...
        var workspaceJsonComponentStream = new ComponentStream { Location = directory.ToString(), Pattern = "package.json", Stream = new MemoryStream(JsonSerializer.SerializeToUtf8Bytes(workspaceJson)) };
    ...
    public async Task WellFormedYarnLockV1WithWorkspace_CheckFilePathsAsync()
    {
        ...
        var workspaceJsonComponentStream = new ComponentStream { Location = directory.ToString(), Pattern = "package.json", Stream = new MemoryStream(Encoding.UTF8.GetBytes(str)) };
